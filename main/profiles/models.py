...
class Profile(models.Model):
    ...
    birth_date = models.CharField(max_length=30, blank=True, null=True, default="")

    height = models.CharField(max_length=30, default="", blank=True, null=True, )
    # 5.인우 : validator는 나중에 좀 더 손봐야 할 것 같습니다. 장난으로 키 막 300 이렇게 적을까봐 일단
    # 넣어봤어요.

    weight = models.CharField(max_length=30, default="", blank=True, null=True)
