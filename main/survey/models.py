...
class StomachacheSurvey(SurveyMeta):
    ...
    location_move = models.CharField(max_length=30, default=False)
    location_move_how = models.CharField(max_length=100)
    pain_spread = models.CharField(max_length=30, default=False)
    pain_spread_where = models.CharField(max_length=100)

    # Duration
    pain_duration = models.CharField(choices=PAIN_DURATION, max_length=20)
    pain_repeated = models.CharField(max_length=30, default=False)
    pain_per_day = models.CharField(choices=PAIN_PER_DAY, max_length=20)

    # Course
    pain_worse = models.CharField(max_length=30, default=False)

    # Experience
    pain_experience = models.CharField(max_length=30, default=False)
